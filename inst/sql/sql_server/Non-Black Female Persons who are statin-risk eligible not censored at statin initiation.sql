...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3015232,3027114,3019900,4198448,37393449,37397989,44809580,4008265)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3015232,3027114,3019900,4198448,37393449,37397989,44809580,4008265)
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3004249,4152194,21492239,3028737)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4153323,4217013)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4153323,4217013)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1545958,1592180,1549686,1592085,40165636,1551860,1510813,1539403)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1545958,1592180,1549686,1592085,40165636,1551860,1510813,1539403)
  and c.invalid_reason is null
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (443454,439847)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4068155,313217,314665,4194288,4323077)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (313217,314665,4194288,4323077)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37109912,438172,4124687,4108678,4163874,45766212,4329847,37109911,4108680,37109910)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37109912,438172,4124687,4108678,4163874,45766212,4329847,37109911,4108680,37109910)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40758583,44786901,4197971,3034639,3004410,3003309,3005673,40762352,3007263,2212392)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2001516,4284104,4229433,4146972,4228305,4228304,4063237,4148030,4008625,4106548,4031996,4234990,45889469,4240486,4336464,4337056,4000733,4336467,4336465,4339629,4337737,4336466,4233421,4305509,4309432,4011931,4253805,45887879,2107242,2107243,2107244,2107231,45889898,2107223,2107224,2107226,2107227,2107228,2107222,45887862,2107217,2107218,2107219,2107220,2107221,2107216,2001515,4000732,4305852,4020216,2001514,4233420,45889467)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4171077,4328103,4216356,4238755,4214516,44789455,2001506,2001505,44511272,44511133,4337738,43531439,43531438,4264286,43533247,43533352,44512256,44784573,44511268,44511269,44511271,45770795,44511131,4020653,44511130,4181025,4006788,2000064,4264285,4265293,4225903,43533353,43533248,43531440,4175997,44511532,4139198,4178148,4329263,4283892,44511273)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4337738,44512256,44784573,44511268,44511269,44511271,45770795,44511131,4020653,44511130,4181025,4006788,2000064,4264285,4265293,4225903,43533353,43533248,43531440,4175997,44511532,4139198,4178148,4329263,4283892,44511273)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44784623,38001109,38001108,38001110,38001112,38001111,38001113,38001139,40761421,443563,438172,4108215,4108678,4163874,4185932,40761359,319038,4108680)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44784623,38001109,38001108,38001110,38001112,38001111,38001113,38001139,40761421,443563,438172,4108215,4108678,4163874,4185932,40761359,319038,4108680)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (315830)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (315830)
  and c.invalid_reason is null
...
WHERE (C.value_as_number >= 130.0000 and C.value_as_number <= 320.0000)
...
WHERE (C.value_as_number >= 3.3700 and C.value_as_number <= 8.2900)
...
WHERE (C.value_as_number >= 90.0000 and C.value_as_number <= 200.0000)
-- End Measurement Criteria
...
WHERE P.race_concept_id in (8657,38003572,38003573,8515,38003574,38003575,38003576,38003577,38003578,38003579,38003580,38003581,38003582,38003583,38003584,38003585,38003586,38003587,38003588,38003589,38003590,38003591,38003592,38003593,38003594,38003595,38003596,38003597,8557,38003610,38003611,38003612,38003613,8527,38003614,38003615,38003616,0) AND P.race_concept_id in (8657,38003572,38003573,8515,38003574,38003575,38003576,38003577,38003578,38003579,38003580,38003581,38003582,38003583,38003584,38003585,38003586,38003587,38003588,38003589,38003590,38003591,38003592,38003593,38003594,38003595,38003596,38003597,8557,38003610,38003611,38003612,38003613,8527,38003614,38003615,38003616,0)
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-1825,P.START_DATE) AND A.START_DATE <= DATEADD(day,0,P.START_DATE)
...
FROM #qualified_events E
JOIN @cdm_database_schema.PERSON P ON P.PERSON_ID = E.PERSON_ID
WHERE (YEAR(E.start_date) - P.year_of_birth >= 40 and YEAR(E.start_date) - P.year_of_birth <= 79)
GROUP BY e.person_id, e.event_id
-- End Demographic Criteria
...
select event_id, person_id, 
  case when DATEADD(day,3650,start_date) > start_date then DATEADD(day,3650,start_date) else start_date end as end_date
INTO #strategy_ends
